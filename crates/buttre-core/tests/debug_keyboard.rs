...
fn debug_huyeenf_no_composition() {
    ...
    for ch in input.chars() {
        ...
        println!("Input '{}': buffer='{}', actions={:?}", ch, keyboard.buffer(), actions);
    }
...
fn debug_huyeenf_with_composition() {
    ...
    let mut keyboard = KeyboardBuilder::telex_with_composition(true).expect("Failed to create telex keyboard");
