//! Telex Vowel Sequence Table
//!
//! **Tests**: Integration tests for this module are located in `crates/buttre-core/tests/keyboard_telex_tests.rs`.
//!
//! This module provides the complete Vietnamese vowel sequence table for Telex input method.
...
/// Get the complete Vietnamese vowel sequence table for Telex
///
