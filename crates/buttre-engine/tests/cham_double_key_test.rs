...
fn test_cham_config_native_script_mode() {
    ...
    assert!(
        config.native_script_mode,
        "native_script_mode should be true for Cham keyboard"
    );
}
...
fn test_cham_single_k_transform() {
    ...
    assert_eq!(
        executor.syllable(),
        "ꨆ",
        "Single 'k' should transform to Cham KA"
    );
}
...
fn test_cham_double_kk_transform() {
    ...
    eprintln!(
        "CONFIG CREATED: native_script_mode = {}",
        config.native_script_mode
    );
    eprintln!(
        "CONFIG transform_rules keys: {:?}",
        config.transform_rules.keys().collect::<Vec<_>>()
    );
    ...
    assert_eq!(
        executor.syllable(),
        "ꩀ",
        "Double 'kk' should transform to Cham final KA"
    );
}
...
fn test_cham_double_gg_transform() {
    ...
    assert_eq!(
        executor.syllable(),
        "ꩁ",
        "Double 'gg' should transform to Cham final GA"
    );
}
