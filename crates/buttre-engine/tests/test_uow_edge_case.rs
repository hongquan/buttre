...
fn test_uow_with_final_consonant() {
    ...
    assert_eq!(executor.context().syllable_buffer, "trường",
               "Expected 'trường' but got '{}'", executor.context().syllable_buffer);
}
...
fn test_uow_without_final_consonant() {
    ...
    assert_eq!(executor.context().syllable_buffer, "cười",
               "Expected 'cười' but got '{}'", executor.context().syllable_buffer);
}
...
fn test_giuowng_with_final_consonant() {
    ...
    assert_eq!(executor.context().syllable_buffer, "giường",
               "Expected 'giường' but got '{}'", executor.context().syllable_buffer);
}
...
fn test_uow_variations() {
    ...
    for (input, expected) in test_cases_with_consonant {
        ...
        assert_eq!(executor.context().syllable_buffer, expected,
                   "Input '{}': expected '{}' but got '{}'", 
                   input, expected, executor.context().syllable_buffer);
    }
